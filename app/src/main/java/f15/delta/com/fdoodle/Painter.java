...
public class Painter extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final ToggleButton mBrushmirror=(ToggleButton)findViewById(R.id.mirror);
        mBrushmirror.setChecked(true);
        final ToggleButton mBrushmirrory=(ToggleButton)findViewById(R.id.mirrory);
        mBrushmirrory.setChecked(false);
        mBrushmirror.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {

                if(mBrushmirror.isChecked()==true)
                {
                    PainterSettings.mir=true;
                }
                else{
                    PainterSettings.mir=false;
                }
            }
        });

        mBrushmirrory.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {

                if(mBrushmirrory.isChecked()==true)
                {
                    PainterSettings.miry=true;
                }
                else{
                    PainterSettings.miry=false;
                }
            }
        });
    ...
    private Dialog createDialogExit() {
        ...
        alert.setPositiveButton("Save and Exit",
                new DialogInterface.OnClickListener() {
